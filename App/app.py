...
# Page configuration
st.set_page_config(page_title="Time Series Forecasting System", page_icon="images/favicon.ico",layout="wide")
...
st.markdown('<h1 class="custom-title">Time Series Forecasting Engine</h1>', unsafe_allow_html=True)
...
menu = st.tabs([":material/database: Data Display", ":material/build: Missing Handling",":material/carpenter: Anomaly Handling", 
                ":material/analytics: Statistical Analysis", ":material/trending_up: Forecasting",":material/bar_chart: Dashboard"])
